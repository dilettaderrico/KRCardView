...
extension KRCardView where Self: UIViewController {
  ...
  public func addKRCardView() {
    ...
    cardViewController.visualEffectView.isUserInteractionEnabled = true
  ...
  func animationTransitionIfNeeded(state: CardState, duration: TimeInterval) {
    ...
    var frameAnimator: UIViewPropertyAnimator {
      ...
      let animator = UIViewPropertyAnimator(duration: duration, dampingRatio: 1) {
        switch state {
        case .expanded:
          bottomView.cardViewController.view.frame.origin.y = UIScreen.main.bounds.height - bottomView.cardHeight
        case .collapsed:
           //bottomView.cardViewController.view.frame.origin.y = self.view.bounds.height - bottomView.cardHandleAreaHeight
            bottomView.cardViewController.view.frame.origin.y = UIScreen.main.bounds.height - bottomView.cardHandleAreaHeight
        //bottomView.cardViewController.view.frame.origin.y = 0 + bottomView.cardHandleAreaHeight
      ...
      animator.addCompletion { _ in
        ...
        bottomView.cardViewController.visualEffectView.isUserInteractionEnabled = false  //!bottomView.cardViewController.cardVisible
        //bottomView.cardViewController.visualEffectView.isUserInteractionEnabled = true
